    ...
    @volt('ai-prompt')
        <div x-data="{ response: @entangle('response') }" class="flex flex-col flex-1 justify-between items-center py-5 mx-auto w-full max-w-xl h-full">
            ...
            <div class="relative bottom-0 left-1/2 w-full max-w-xl -translate-x-1/2">
                ...
                <input wire:model="prompt" type="text" class="px-2 py-2.5 pr-24 pl-10 w-full text-sm rounded-md border border-outline bg-neutral-50 border-neutral-300 text-neutral-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75 dark:border-neutral-700 dark:bg-neutral-900/50 dark:text-neutral-300 dark:focus-visible:outline-white" name="prompt" placeholder="Ask AI ..." />
